...
def main():
    ...
    # Checkbox for visualization options
    st.sidebar.subheader("Visualization Options")
    show_scatter = st.sidebar.checkbox("Show Scatter Plot", value=True)  # Scatter plot is enabled by default

    if protein_names:
        # Split input text into a list of protein names
        ...
        for protein_name in protein_names_list:
            ...
            results = {}
            protein_found = False  # Flag to check if the protein is found in any dataset
            ...
            if protein_found:  # Only proceed if the protein is found
    ...
    # Footer at the end of the main page
    display_footer()
